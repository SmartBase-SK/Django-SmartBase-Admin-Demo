...
DEFAULT_CACHE_CONFIG = {
    ...
    "OPTIONS": {
        "CONNECTION_POOL_CLASS_KWARGS": {
            "connection_class": "sbcore.config.redis.cache.FailsafeConnection",
        },
        "OPTIONS": {
...
EMAIL_BACKEND = 'sbcore.config.email_backend.EmailAllToAdminBackend'
...
if ENVIRONMENT == 'production':
    ...
    DEFAULT_FROM_EMAIL = SERVER_EMAIL
    EMAIL_POST_OFFICE_BACKEND = 'sbcore.config.email_backend.EmailAllToAdminBackend'
